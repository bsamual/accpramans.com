	                      ...
	                      <table class="table">
	                        ...
	                        <tr>
                              ...
                              elseif($task->status == 2)
                              {
                                ...
                                ?>
                                <a href="javascript:" class="common_black_button <?php echo $complete_button; ?>" data-element="<?php echo $task->id; ?>">Mark Complete</a><br/><br/>
                                <a href="javascript:" class="common_black_button activate_task_button" data-element="<?php echo $task->id; ?>">Activate</a>
                                <?php
                              }
                              else{
                                if(Session::has('taskmanager_user'))
                                ...
                                ?>
                                <a href="javascript:" class="common_black_button <?php echo $complete_button; ?>" data-element="<?php echo $task->id; ?>">Mark Complete</a><br/><br/>
                                <a href="javascript:" class="common_black_button park_task_button" data-element="<?php echo $task->id; ?>">Park Task</a>
                                <?php
                              }
                              ?>
